...
func init(params):
	...
	self.ai.init({
		...
		"learning_rate_decay_time": params.learning_rate_decay_time,
		"learning_interpolator": params.learning_interpolator,
		...
		"exploration_interpolator": params.exploration_interpolator,
		"max_idle_rate": params.max_idle_rate,
		"min_idle_rate": params.min_idle_rate,
		"idle_rate_decay_time": params.idle_rate_decay_time,
		"idle_interpolator": params.idle_interpolator,
